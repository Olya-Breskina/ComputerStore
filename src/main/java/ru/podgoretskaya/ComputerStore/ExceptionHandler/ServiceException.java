package ru.podgoretskaya.ComputerStore.ExceptionHandler;
...
public class ServiceException {
    ...
    public ResponseEntity<String> newException(HttpMessageNotReadableException e) {
        log.error(e.getMessage(), e);
        String apiError = new String("Данные о товаре не сохранены. Проверьте корректность введенных данных и попробуйте снова");
        return new ResponseEntity<>(apiError, HttpStatus.NOT_FOUND);
    }
}
